...
/**
 * Created by qiuweiyu on 2018/7/2.
 */
...
//    LabelsView labelView;
    ...
    private void initView() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            RxPermissions permissions = new RxPermissions(TestActivity.this);
...
//        marker.showInfoWindow();// 设置默认显示一个infowinfow
    ...
    private void initMedia(final VideoBean video) {
        playView.setUp(video.getUrl(),JZVideoPlayerStandard.SCREEN_WINDOW_NORMAL, "");
        ...
        playView.thumbImageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
        ...
        playView.fullscreenButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                playView.startWindowFullscreen();
