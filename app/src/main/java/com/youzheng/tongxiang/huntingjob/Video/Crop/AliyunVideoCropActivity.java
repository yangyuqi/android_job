...
package com.youzheng.tongxiang.huntingjob.Video.Crop;
...
import com.youzheng.tongxiang.huntingjob.Video.Crop.media.FrameExtractor10;
import com.youzheng.tongxiang.huntingjob.Video.Crop.media.MediaInfo;
import com.youzheng.tongxiang.huntingjob.Video.Crop.media.VideoTrimAdapter;
import com.youzheng.tongxiang.huntingjob.Video.Crop.view.FanProgressBar;
import com.youzheng.tongxiang.huntingjob.Video.Crop.view.HorizontalListView;
import com.youzheng.tongxiang.huntingjob.Video.Crop.view.SizeChangedNotifier;
import com.youzheng.tongxiang.huntingjob.Video.Crop.view.VideoSliceSeekBar;
import com.youzheng.tongxiang.huntingjob.Video.Crop.view.VideoTrimFrameLayout;
import com.youzheng.tongxiang.huntingjob.Video.MediaActivity;
...
//    private MediaScannerConnection msc;
    ...
    private static int getLastWidth ,getLastHeight;
    ...
    private void startCrop() {
        ...
        switch (ratioMode) {
            ...
            case AliyunSnapVideoParam.RATIO_MODE_9_16:
                ...
                break;
            default:
                outputRatio = (float) 9 / 16;
                break;
        }
        if (videoRatio > outputRatio) {
            getLastWidth = videoWidth;
            getLastHeight =videoHeight;
            posX = 0;
    ...
    public void onComplete(long duration) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                intent.putExtra("width",getLastWidth);
                intent.putExtra("height",getLastHeight);
                //裁剪之后的跳转
                String tagClassName = AliyunSvideoActionConfig.getInstance().getAction().getTagClassName(ActionInfo.SVideoAction.CROP_TARGET_CLASSNAME);
                if (tagClassName == null){
                    setResult(Activity.RESULT_OK, intent);
